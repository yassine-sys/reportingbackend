...
public class EtatCollectRepository {
    ...
    public List<EtatCollect> findByDate(String date) {
        ...
        //String sql = "SELECT date_collect, name_flow , name_rep,switch , nb_files, nb_records, files_processed, nb_corrupted, average FROM tables.stat_collect WHERE date_collect = ? ORDER BY date_collect desc";
        ...
        for (Object[] row : resultRows) {
            ...
            //etatCollectDTO.setFrequency((String) row[3]);
    ...
    public List<EtatCollect> getAll() {
        ...
        //String sql = "SELECT date_collect, name_flow, name_rep,switch , nb_files, nb_records, files_processed, nb_corrupted, average FROM tables.stat_collect ORDER BY date_collect desc";
        Query query = entityManager.createNativeQuery(sql);
